...
gulp.task('release', function(done) {
    ...
    mkdirp('release', function() {
        for(var os of platforms) {
            switch (os) {
                case 'win32':
                    if (fs.existsSync(BUILD_DIR + 'BTT_Writer-win32-ia32/')) {
                    ...
                    break;
                case 'win64':
                    if (fs.existsSync(BUILD_DIR + 'BTT_Writer-win32-x64/')) {
                    ...
                    break;
                case 'darwin':
                    if (fs.existsSync(BUILD_DIR + 'BTT_Writer-darwin-x64/')) {
                        promises.push(new Promise(function (os, resolve, reject) {
                            ...
                            try {
                                ...
                                archive.pipe(output);
                                archive.directory(BUILD_DIR + 'BTT_Writer-darwin-x64/BTT_Writer.app/', 'BTT_Writer.app');
                                archive.finalize();
                            } catch (e) {
                                console.error(e);
                                resolve({
                    ...
                    break;
                case 'linux':
                    if (fs.existsSync(BUILD_DIR + 'BTT_Writer-linux-x64/')) {
                        promises.push(new Promise(function (os, resolve, reject) {
                            ...
                            try {
                                ...
                                archive.on('error', reject);
                                archive.pipe(output);
                                archive.directory(BUILD_DIR + 'BTT_Writer-linux-x64/', 'BTT_Writer');
                                archive.finalize();
                            } catch (e) {
                                console.error(e);
                                resolve({
